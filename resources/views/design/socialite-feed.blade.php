                    ...
                    <div class="max-w-[1220px] mx-auto flex items-center">
                        ...
                        <div class="hidden uk- open z-10"
                                ...
                                <div class="xl:w-[694px] sm:w-96 bg-white dark:bg-dark3 w-screen p-2 rounded-lg shadow-lg -mt-14 pt-14">
                                    ...
                                    <nav class="text-sm font-medium text-black dark:text-white">
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="/assets/socialite/images/avatars/avatar-2.jpg" class="w-9 h-9 rounded-full"> <div>   <div> Jesse Steeve </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="/assets/socialite/images/avatars/avatar-2.jpg" class="w-9 h-9 rounded-full"> <div>   <div>  Martin Gray </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="/assets/socialite/images/group/group-2.jpg" class="w-9 h-9 rounded-full"> <div>   <div>  Delicious Foods  </div>  <div class="text-xs text-rose-500 font-medium mt-0.5">  Group </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="/assets/socialite/images/group/group-1.jpg" class="w-9 h-9 rounded-full"> <div>   <div> Delicious Foods  </div>  <div class="text-xs text-yellow-500 font-medium mt-0.5">  Page </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                        <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src="/assets/socialite/images/avatars/avatar-6.jpg" class="w-9 h-9 rounded-full"> <div>   <div>  John Welim </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                        ...
                        <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
                                ...
                                <div class="text-sm h-[400px] w-full overflow-y-auto pr-2">
                                    ...
                                    <div class="pl-2 p-1 text-sm font-normal dark:text-white">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10 bg-teal-500/5">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="/assets/socialite/images/avatars/avatar-3.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="/assets/socialite/images/avatars/avatar-7.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="/assets/socialite/images/avatars/avatar-6.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="/assets/socialite/images/avatars/avatar-2.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 "> 
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="/assets/socialite/images/avatars/avatar-4.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
                                    ...
                                    <div class="p-2 pt-0 pr-1 dark:text-white/80">
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="/assets/socialite/images/avatars/avatar-2.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="/assets/socialite/images/avatars/avatar-4.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="/assets/socialite/images/avatars/avatar-5.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                                    <div class="mr-auto text-sm text-black dark:text-white font-medium">Jesse Steeve</div>
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="/assets/socialite/images/avatars/avatar-3.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="/assets/socialite/images/avatars/avatar-7.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                            ...
                            <div  class="rounded-full relative bg-secondery cursor-pointer shrink-0">
                                <img src="/assets/socialite/images/avatars/avatar-2.jpg" alt="" class="sm:w-9 sm:h-9 w-7 h-7 rounded-full shadow shrink-0"> 
                            </div>
                            <div  class="hidden bg-white rounded-lg drop-shadow-xl dark:bg-slate-700 w-64 border2"
                                ...
                                <a href="timeline.html">
                                    <div class="p-4 py-5 flex items-center gap-4">
                                        <img src="/assets/socialite/images/avatars/avatar-2.jpg" alt="" class="w-10 h-10 rounded-full shadow">
                                        <div class="flex-1">
                ...
                <div class="pr-4" data-simplebar>
                    ...
                    <nav id="side">
                        ...
                        <ul>
                            <li class="active">
                                <a href="feed.html">
                                    <img src="/assets/socialite/images/icons/home.png" alt="feeds" class="w-6">
                                    <span> Feed </span> 
                                </a>
                            </li>
                            <li>
                                <a href="messages.html">
                                    <img src="/assets/socialite/images/icons/message.png" alt="messages" class="w-5">
                                    <span> messages </span> 
                                </a>
                            </li> 
                            <li>
                                <a href="video.html">
                                    <img src="/assets/socialite/images/icons/video.png" alt="messages" class="w-6">
                                    <span> video </span> 
                                </a>
                            </li>
                            <li>
                                <a href="event.html">
                                    <img src="/assets/socialite/images/icons/event.png" alt="messages" class="w-6">
                                    <span> event </span> 
                                </a>
                            </li>
                            <li>
                                <a href="pages.html">
                                    <img src="/assets/socialite/images/icons/page.png" alt="pages" class="w-6">
                                    <span> Pages </span> 
                                </a>
                            </li>
                            <li>
                                <a href="groups.html">
                                    <img src="/assets/socialite/images/icons/group.png" alt="groups" class="w-6">
                                    <span> Groups </span> 
                                </a>
                            </li>
                            <li>
                                <a href="market.html">
                                    <img src="/assets/socialite/images/icons/market.png" alt="market" class="w-7 -ml-1">
                                    <span> market </span> 
                                </a>
                            </li> 
                            <li>
                                <a href="blog.html">
                                    <img src="/assets/socialite/images/icons/blog.png" alt="blog" class="w-6">
                                    <span> blog </span> 
                                </a>
                            </li> 
                            <li class="!hidden" id="show__more">
                                <a href="games.html">
                                    <img src="/assets/socialite/images/icons/game.png" alt="games" class="w-6">
                                    <span> games </span> 
                                </a>
                            </li>
                            <li class="!hidden" id="show__more">
                                <a href="funding.html">
                                    <img src="/assets/socialite/images/icons/fund.png" alt="messages" class="w-6">
                                    <span> Fundraiser  </span> 
                                </a>
                            </li>
                            <li class="!hidden" id="show__more">
                                <a href="blog-2.html">
                                    <img src="/assets/socialite/images/icons/blog-2.png" alt="blog" class="w-6">
                                    <span> blog II </span> 
                                </a>
                            </li>
                            <li class="!hidden" id="show__more">
                                <a href="event-2.html">
                                    <img src="/assets/socialite/images/icons/event-2.png" alt="event" class="w-6">
                                    <span> Event II </span> 
                                </a>
                            </li>
                            <li class="!hidden" id="show__more">
                                <a href="groups-2.html">
                                    <img src="/assets/socialite/images/icons/group-2.png" alt="groups" class="w-6">
                                    <span> Groups II </span> 
                                </a>
                            </li>
                    ...
                    <div class="font-medium text-sm text-black border-t pt-3 mt-2 dark:text-white dark:border-slate-800">
                        ...
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/assets/socialite/images/avatars/avatar-2.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div> Marin Gray</div>
                            </div>
                        </a>
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/assets/socialite/images/avatars/avatar-7.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div>   Alexa Stella</div>
                            </div>
                        </a>
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/assets/socialite/images/avatars/avatar-3.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div> Sarah Ali</div>
                            </div>
                        </a> 
                    </div>
                    ...
                    <nav id="side">
                        <ul>
                            <li class="active">
                                <a href="{{ url('/feed') }}">
                                    <img src="/assets/socialite/images/icons/home.png" alt="Feed" class="w-6">
                                    <span> Feed </span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ url('/moments') }}">
                                    <img src="/assets/socialite/images/icons/video.png" alt="Moments" class="w-6">
                                    <span> Moments </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/cups') }}">
                                    <img src="/assets/socialite/images/icons/event.png" alt="Cups" class="w-6">
                                    <span> Cups </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/teams') }}">
                                    <img src="/assets/socialite/images/icons/group.png" alt="Teams" class="w-6">
                                    <span> Teams </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/lfg') }}">
                                    <img src="/assets/socialite/images/icons/page.png" alt="LFG" class="w-6">
                                    <span> LFG </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/team-lfg') }}">
                                    <img src="/assets/socialite/images/icons/group-2.png" alt="Team LFG" class="w-6">
                                    <span> Team-LFG </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/members') }}">
                                    <img src="/assets/socialite/images/icons/group-2.png" alt="Members" class="w-6">
                                    <span> Members </span>
                                </a>
                            </li>
                            <li class="!hidden" id="show__more">
                                <a href="{{ url('/notifications') }}">
                                    <img src="/assets/socialite/images/icons/message.png" alt="Notifications" class="w-6">
                                    <span> Notifications </span>
                                </a>
                            </li>
                            <li class="!hidden" id="show__more">
                                <a href="{{ url('/referrals') }}">
                                    <img src="/assets/socialite/images/icons/fund.png" alt="Referrals" class="w-6">
                                    <span> Referrals </span>
                                </a>
                            </li>
                            <li class="!hidden" id="show__more">
                                <a href="https://huntmaps.online/embed" target="_blank" rel="noopener">
                                    <img src="/assets/socialite/images/icons/market.png" alt="Huntmaps" class="w-7 -ml-1">
                                    <span> Huntmaps </span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="font-medium text-sm text-black border-t pt-3 mt-2 dark:text-white dark:border-slate-800">
                        ...
                        <a href="{{ url('/teams/manage') }}">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/assets/socialite/images/icons/group.png" alt="" class="w-6 rounded-full object-cover">
                                <div> My teams</div>
                            </div>
                        </a>
                        <a href="{{ url('/app-beta') }}">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/assets/socialite/images/icons/game.png" alt="" class="w-6 rounded-full object-cover">
                                <div> Android beta</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <nav id="side" class="font-medium text-sm text-black border-t pt-3 mt-2 dark:text-white dark:border-slate-800">
                        ...
                        <ul class="mt-2 -space-y-2" uk-nav="multiple: true">
                            ...
                            <li>
                                <a href="{{ url('/settings/security') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-7.5 8.25h9a2.25 2.25 0 002.25-2.25V9.75A2.25 2.25 0 0016.5 7.5H15a3 3 0 00-6 0H7.5A2.25 2.25 0 005.25 9.75v6A2.25 2.25 0 007.5 18z" />
                                    </svg>
                                    <span> Security </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/nutzungsbedingungen') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                            ...
                            <li class="uk-parent">
                                ...
                                <ul class="pl-10 my-1 space-y-0 text-sm">
                                    <li><a href="{{ url('/impressum') }}" class="!py-2 !rounded-md">Impressum</a></li>
                                    <li><a href="{{ url('/datenschutz') }}" class="!py-2 !rounded-md">Privacy</a></li>
                                    <li><a href="{{ url('/account-deletion') }}" class="!py-2 !rounded-md">Account deletion</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div class="text-xs font-medium flex flex-wrap gap-2 gap-y-0.5 p-2 mt-2">
                        <a href="{{ url('/impressum') }}" class="hover:underline">Impressum</a>
                        <a href="{{ url('/datenschutz') }}" class="hover:underline">Privacy</a>
                        <a href="{{ url('/nutzungsbedingungen') }}" class="hover:underline">Terms</a>
                        <a href="{{ url('/app-beta') }}" class="hover:underline">Android beta</a>
                    </div>
                    @endif
                ...
                <div class="flex-1"> 
                    ...
                    <div class="box p-5 px-6 border1 dark:bg-dark2 hidden">
                        ...
                        <div class="space-y-4 capitalize text-xs font-normal mt-5 mb-2 text-gray-500 dark:text-white/80">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src="/assets/socialite/images/avatars/avatar-7.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src="/assets/socialite/images/avatars/avatar-5.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src="/assets/socialite/images/avatars/avatar-2.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src="/assets/socialite/images/avatars/avatar-3.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.html">
                                    <img src="/assets/socialite/images/avatars/avatar-4.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                                ...
                                <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
                                         ...
                                         <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src="/assets/socialite/images/product/product-1.jpg" alt="" class="object-cover w-full h-full inset-0">
                                                </div> 
                                    ...
                                    <li class="w-1/2 pr-2">
                                         ...
                                         <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src="/assets/socialite/images/product/product-3.jpg" alt="" class="object-cover w-full h-full inset-0">
                                                </div> 
                                    ...
                                    <li class="w-1/2 pr-2">
                                        ...
                                        <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src="/assets/socialite/images/product/product-5.jpg" alt="" class="object-cover w-full h-full inset-0">
                                                </div> 
                                                <div class="absolute right-0 top-0 m-2 bg-white/60 rounded-full py-0.5 px-2 text-sm font-semibold dark:bg-slate-800/60"> $12 </div>
                                            </div>
                    ...
                    <div class="space-y -m t-5 p-3 text-sm font-medium h-[280px] overflow-y-auto">
                        ...
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/assets/socialite/images/avatars/avatar-1.jpg" alt="" class="w-7 rounded-full">
                                <div> Jesse Steeve </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/assets/socialite/images/avatars/avatar-2.jpg" alt="" class="w-7 rounded-full">
                                <div> John Michael </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/assets/socialite/images/avatars/avatar-3.jpg" alt="" class="w-7 rounded-full">
                                <div> Monroe Parker </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/assets/socialite/images/avatars/avatar-5.jpg" alt="" class="w-7 rounded-full">
                                <div> James Lewis </div>
                            </div>
                        </a> 
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/assets/socialite/images/avatars/avatar-4.jpg" alt="" class="w-7 rounded-full">
                                <div> Martin Gray </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/assets/socialite/images/avatars/avatar-6.jpg" alt="" class="w-7 rounded-full">
                                <div> Alexa stella </div>
                            </div>
                        </a>
                        <a href="#" class="block">
