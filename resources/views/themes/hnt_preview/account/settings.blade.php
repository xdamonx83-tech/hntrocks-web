@php
    ...
    if (! str_contains($settingsDemoHtml, 'real-general-settings.css')) {
        $settingsDemoHtml = str_replace(
            '</head>',
            '<link href="'.asset('assets/themes/hnt_preview/settings/real-general-settings.css').'?v=20260718-4" rel="stylesheet"/>' . "\n" . '</head>',
            $settingsDemoHtml
        );
    }
    ...
    $sharedHeaderRuntime = implode("\n", [
        ...
        '<script src="'.asset('assets/themes/hnt_preview/settings/real-security-settings.js').'?v=20260718-3"></script>',
    ]);
