@php
    $teamManageCssVersion = @filemtime(public_path('assets/themes/hnt_preview/dashboard-cups/team-manage.css')) ?: time();
...
<title>Night Ravens verwalten · HNT.ROCKS</title>
...
<link href="{{ asset('assets/themes/hnt_preview/dashboard-cups/team-manage.css') }}?v={{ $teamManageCssVersion }}" rel="stylesheet"/>
</head>
