...
<h2 id="profileTabTitle">{{ $profileDefaultTab === 'posts' ? __('hnt_preview.profile.posts') : __('hnt_preview.profile.info') }}</h2>
</div>
...
@endif
<button aria-controls="profileTabInfo" aria-selected="{{ $profileDefaultTab === 'info' ? 'true' : 'false' }}" class="{{ $profileDefaultTab === 'info' ? 'active' : '' }}" data-profile-tab="info" data-title="{{ __('hnt_preview.profile.info') }}" role="tab" type="button">{{ __('hnt_preview.profile.info') }}</button>
