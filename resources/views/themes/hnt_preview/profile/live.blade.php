...
<script src="{{ asset('assets/themes/hnt_preview/dashboard-feed/real-feed-functionality.js') }}?v={{ @filemtime(public_path('assets/themes/hnt_preview/dashboard-feed/real-feed-functionality.js')) ?: time() }}"></script>
