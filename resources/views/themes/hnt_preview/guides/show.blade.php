...
@auth
<form class="guide-comment-form" action="{{ route('guides.comments.store', $guide) }}" method="post" data-guide-comment-form data-label-author="{{ __('guides.comments.author_badge') }}" data-label-reply="{{ __('guides.comments.reply') }}" data-label-edit="{{ __('guides.comments.edit') }}" data-label-delete="{{ __('guides.comments.delete') }}" data-label-report="{{ __('guides.detail.report') }}" data-label-report-details="{{ __('guides.detail.report_details') }}" data-label-report-send="{{ __('guides.detail.report_send') }}">@csrf
...
@include('themes.hnt_preview.guides.partials.comment', ['comment' => $comment, 'guide' => $guide, 'isReply' => false])
@empty
