...
use App\Http\Controllers\Teams\TeamContractController;
use App\Http\Controllers\Teams\TeamSessionController;
...
Route::middleware('auth')->group(function (): void {
    ...
    Route::post('/teams/{team:slug}/contracts/{template:key}/activate', [TeamContractController::class, 'activate'])->name('teams.contracts.activate');
    Route::post('/teams/{team:slug}/contracts/{teamContract}/cancel', [TeamContractController::class, 'cancel'])->name('teams.contracts.cancel');
    Route::post('/teams/{team:slug}/sessions', [TeamSessionController::class, 'store'])->name('teams.sessions.store');
    Route::patch('/teams/{team:slug}/sessions/{teamSession}', [TeamSessionController::class, 'update'])->name('teams.sessions.update');
    Route::post('/teams/{team:slug}/sessions/{teamSession}/respond', [TeamSessionController::class, 'respondToSession'])->name('teams.sessions.respond');
    Route::post('/teams/{team:slug}/sessions/{teamSession}/cancel', [TeamSessionController::class, 'cancel'])->name('teams.sessions.cancel');
    Route::post('/teams/{team:slug}/sessions/{teamSession}/complete', [TeamSessionController::class, 'complete'])->name('teams.sessions.complete');
