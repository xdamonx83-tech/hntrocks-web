...
use App\Http\Controllers\Api\V1\ApiTeamContractsController;
use App\Http\Controllers\Api\V1\ApiTeamParticipationController;
use App\Http\Controllers\Api\V1\ApiTeamProgressController;
use App\Http\Controllers\Api\V1\ApiTeamSessionsController;
...
Route::prefix('v1')->name('api.v1.')->group(function (): void {
    ...
    Route::middleware(['api.token', 'block.visibility'])->group(function (): void {
        ...
        Route::get('/teams/{team:slug}/progress', [ApiTeamProgressController::class, 'show'])->name('teams.progress.show');
        Route::get('/teams/{team:slug}/contracts', [ApiTeamContractsController::class, 'index'])->name('teams.contracts.index');
        Route::post('/teams/{team:slug}/contracts/{template:key}/activate', [ApiTeamContractsController::class, 'activate'])->name('teams.contracts.activate');
        Route::post('/teams/{team:slug}/contracts/{teamContract}/cancel', [ApiTeamContractsController::class, 'cancel'])->name('teams.contracts.cancel');
        Route::get('/teams/{team:slug}/sessions', [ApiTeamSessionsController::class, 'index'])->name('teams.sessions.index');
        Route::post('/teams/{team:slug}/sessions', [ApiTeamSessionsController::class, 'store'])->name('teams.sessions.store');
        Route::get('/teams/{team:slug}/sessions/{teamSession}', [ApiTeamSessionsController::class, 'show'])->name('teams.sessions.show');
        Route::patch('/teams/{team:slug}/sessions/{teamSession}', [ApiTeamSessionsController::class, 'update'])->name('teams.sessions.update');
        Route::post('/teams/{team:slug}/sessions/{teamSession}/respond', [ApiTeamSessionsController::class, 'respond'])->name('teams.sessions.respond');
        Route::post('/teams/{team:slug}/sessions/{teamSession}/cancel', [ApiTeamSessionsController::class, 'cancel'])->name('teams.sessions.cancel');
        Route::post('/teams/{team:slug}/sessions/{teamSession}/complete', [ApiTeamSessionsController::class, 'complete'])->name('teams.sessions.complete');
        Route::get('/teams/{team:slug}/participation', [ApiTeamParticipationController::class, 'index'])->name('teams.participation.index');
