...
class ArcadeGameResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            'key' => $this->key,
            'name' => $this->{'name_'.$locale} ?: $this->name_de,
            'description' => $this->{'description_'.$locale} ?: $this->description_de,
            ...
            'casual_enabled' => $this->casual_enabled,
            'ranked_enabled' => $this->ranked_enabled,
            'game_version' => $this->game_version,
            'client_engine_key' => $this->client_engine_key,
            'min_client_version' => $this->min_client_version,
            'launch_url' => $this->launch_url,
            'badge' => $this->{'badge_'.$locale} ?: $this->badge_de,
            'is_playable' => $playable,
            'unavailable_reason' => $reason,
            'settings' => $this->settings ?? (object) [],
            'dynamic_client' => app(ArcadeGameReleaseService::class)->publicDescriptor($this->resource),
        ];
    }
}
