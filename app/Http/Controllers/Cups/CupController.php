...
class CupController extends Controller
{
    ...
    private function validatedCupData(Request $request, ?Cup $cup = null): array
    {
        return $request->validate([
            ...
            'summary_es' => ['nullable', 'string', 'max:255'],
            'summary_ru' => ['nullable', 'string', 'max:255'],
            'rules' => ['nullable', 'string', 'max:6000'],
            'rules_de' => ['nullable', 'string', 'max:6000'],
            'rules_en' => ['nullable', 'string', 'max:6000'],
            'rules_es' => ['nullable', 'string', 'max:6000'],
            'rules_ru' => ['nullable', 'string', 'max:6000'],
            ...
            'hall_of_fame_note_es' => ['nullable', 'string', 'max:2000'],
            'hall_of_fame_note_ru' => ['nullable', 'string', 'max:2000'],
    ...
    private function extractCupContentSettings(array &$validated): array
    {
        ...
        foreach ([
            ...
            'hall_of_fame_note_es',
            'hall_of_fame_note_ru',
        ] as $key) {
            unset($validated[$key]);
        }
